    ...
    <table class="table table-dark">
        <thead>
          <tr>
            ...
            <th scope="col">Last Upated At</th>
            <th scope="col"></th>
            <th scope="col"></th>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>{{ $gearList->created_at }}</td>
            <td>{{ $gearList->updated_at ?? '' }}</td>
