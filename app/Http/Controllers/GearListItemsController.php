...
class GearListItemsController extends Controller
{
    ...
    public function index($listId)
    {
        ...
        return view('gear-lists.gear-list-by-item',['gearList'=>$gearList,'gearListItems'=>$gearListItems,'user'=>$user, 'itemCategories'=>$itemCategories,'sortingOptions'=> $listSortingOptions,'listClasses'=>$listClasses]);
    }
